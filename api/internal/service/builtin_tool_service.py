...
class BuiltinToolService:
    ...
    builtin_category_managet: BuiltinCategoryManager
    ...
    def get_provider_icon(self, provider_name: str) -> tuple[bytes, str]:
        ...
        # 2.获取项目的根路径信息
        root_path: str = os.path.dirname(os.path.dirname(current_app.root_path))
    ...
    def get_categories(self) -> list[dict[str, Any]]:
        ...
        category_map = self.builtin_category_managet.get_category_map()
        return [{
