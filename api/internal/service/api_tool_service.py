...
class ApiToolService(BaseService):
    ...
    def update_api_tool_provider(
        ...
        """根据传递provider_id+req更新对应的API工具提供者信息"""
    ...
    def get_api_tool_providers_with_page(
        ...
        if req.search_word.data:
            filters.append(ApiToolProvider.name.ilike(f"%{req.search_word.data}%"))  # 模糊查询
    ...
    def create_api_tool(self, req: CreateApiToolReq, account: Account) -> ApiTool:
        """根据传递的请求创建自定义API工具"""
        ...
        # 3.首先创建工具提供者，并获取工具提供者的id信息，然后在创建工具信息，然后再创建工具信息
