...
Revision ID: e1508ae0a0cf
Revises: cea14266aeb0
Create Date: 2026-07-10 14:57:42.948915
...
revision = 'e1508ae0a0cf'
down_revision = 'cea14266aeb0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('account_id', sa.UUID(), server_default=sa.text('uuid_generate_v4()'), nullable=False),
