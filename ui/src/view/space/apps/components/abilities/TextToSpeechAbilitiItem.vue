...
<template>
  <div class="">
    <a-collapse-item
      key="text_to_speech"
      class="app-ability-item text-to-speech-ability-item"
    >
      <template #header>
      ...
      <template #extra>
        ...
        >
          <a-button
            size="mini"
            class="rounded-lg flex items-center gap-1 px-1"
            @click.stop
          >
          ...
          <template #content>
            <a-doption
              :value="1"
              class="text-xs py-1.5 text-gray-700"
              >开启</a-doption
            >
            <a-doption
              :value="0"
              class="text-xs py-1.5 text-red-700"
              >关闭</a-doption
            >
          </template>
        </a-dropdown>
          ...
          <div class="flex flex-col gap-2">
            <div class="flex flex-col">
              ...
              <div class="text-gray-500 text-xs">
                不同的音色适用于不同的场景，请结合业务进行选择。
              </div>
            </div>
            <a-select v-model:model-value="textToSpeechForm.voice">
              <a-option value="alex">alex</a-option>
              <a-option value="benjamin">benjamin</a-option>
              <a-option value="charles">charles</a-option>
              <a-option value="david">david</a-option>
              <a-option value="anna">anna</a-option>
              <a-option value="bella">bella</a-option>
              <a-option value="claire">claire</a-option>
              <a-option value="diana">diana</a-option>
            </a-select>
          </div>
          <!-- 自动播放 -->
          <div class="flex flex-col gap-2">
