<template>
  <div class="">
    ...
    >
      ...
      <!-- 停止调试会话 -->
      <div
        v-if="task_id && debugChatLoading"
        class="h-[50px] flex items-center justify-center"
      >
        <a-button
          :loading="stopDebugChatLoading"
    ...
    <div class="w-full flex flex-col flex-shrink-0">
      ...
      <div class="px-6 flex items-center gap-4">
        ...
        <!-- 输入框组件 -->
        <div
          :class="`${image_urls.length > 0 ? 'h-[100px]' : 'h-[50px]'} flex flex-col justify-center gap-2 px-4 flex-1 bg-white border border-gray-200 rounded-2xl shadow-sm focus-within:border-blue-400 focus-within:shadow-[0_0_0_3px_rgba(59,130,246,0.1)] transition-all duration-300`"
        >
          <!-- 图片列表 -->
          <div
          ...
          <div class="flex items-center gap-2">
            <input
              v-model="query"
              type="text"
              class="flex-1 outline-none focus:outline-none focus:ring-0 focus:border-transparent bg-transparent text-gray-700 placeholder-gray-400"
            ...
            <a-button
              ...
              type="primary"
              shape="circle"
              class="!bg-gradient-to-r !from-blue-500 !to-indigo-500 !border-0 !shadow-md !shadow-blue-200 hover:!from-blue-600 hover:!to-indigo-600 hover:!shadow-lg hover:!shadow-blue-300 transition-all duration-300"
              @click="handleSubmit"
            >
              <template #icon>
                <icon-send :size="16" />
