    ...
    <div class="min-h-[calc(100vh-160px)] p-[48px]">
      ...
      >
        ...
        >
          ...
          <!-- 自定义表单 -->
          <div
            v-if="createDocumentsForm.process_type === 'custom'"
            class=""
          >
            <a-divider />
            <!-- 表单选项 -->
            <a-form
              :model="createDocumentsForm.rule"
      ...
      >
        ...
        <div class="flex flex-col gap-2">
          ...
          >
            ...
            <div
              v-else-if="document.status === 'completed'"
              class=""
            >
              处理完成
            </div>
