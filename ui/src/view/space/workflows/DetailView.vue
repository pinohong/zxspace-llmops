...
const NOTE_TYPES = {
  ...
  code_executor: markRaw(CodeNode),
...
const nodeInfoComponentMap: Record<string, any> = {
  start: markRaw(StartNodeInfo),
  llm: markRaw(LlmNodeInfo),
  template_transform: markRaw(TemplateTransformNodeInfo),
  code_executor: markRaw(CodeNodeInfo),
  http_request: markRaw(HttpRequestNodeInfo),
  dataset_retrieval: markRaw(DatasetRetrievalNodeInfo),
  tool: markRaw(ToolNodeInfo),
  question_classifier: markRaw(QuestionClassifierNodeInfo),
  iteration: markRaw(IterationNodeInfo),
  end: markRaw(EndNodeInfo),
}
const {
...
// 定义节点更新事件
const onUpdateNode = async (node_data: Record<string, any>) => {
  // 获取该节点对应的索引
  ...
  <div class="h-screen flex flex-col overflow-hidden relative">
    ...
    <div class="flex-1 min-h-0 relative">
      ...
      >
            ...
            <a-space :size="8">
                    ...
                    >
                      ...
                      <div class="flex items-center gap-2">
                        <a-avatar
                          shape="square"
                          :size="24"
                          class="bg-orange-500 rounded-lg"
                        >
                          <icon-tool />
                        </a-avatar>
                    ...
                    >
                      ...
                      <div class="flex items-center gap-2">
                        <a-avatar
                          shape="square"
                          :size="24"
                          class="bg-violet-500 rounded-lg"
                        >
                          <icon-storage />
                        </a-avatar>
                    ...
                    >
                      ...
                      <div class="flex items-center gap-2">
                        <a-avatar
                          shape="square"
                          :size="24"
                          class="bg-emerald-400 rounded-lg"
                        >
                          <icon-branch />
                        </a-avatar>
              ...
              <div class="flex items-center gap-3">
                ...
                >
                  <a-button
                    size="small"
                    class="!text-gray-700 px-2 rounded-lg gap-1 w-[80px]"
                  >
        ...
        <!-- 节点信息容器 -->
        <component
          :is="nodeInfoComponentMap[selectedNode?.type]"
          v-if="selectedNode && nodeInfoVisible && nodeInfoComponentMap[selectedNode?.type]"
          :loading="updateDraftGraphLoading"
          :node="selectedNode"
