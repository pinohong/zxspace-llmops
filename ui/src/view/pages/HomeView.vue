...
const opening_questions = ['什么是智序空间?', '我想创建一个应用', '能介绍下什么是RAG吗?']
...
<template>
  <div
    class="w-full h-full max-h-screen bg-gray-100 bg-cover bg-no-repeat bg-center relative"
    :style="{ backgroundImage: `url(${AssistantAgentBackground})` }"
  >
    <!-- 科技感遮罩层 -->
    <div
      class="absolute inset-0 bg-gradient-to-b from-cyan-50/60 via-white/30 to-indigo-100/50"
    ></div>
    <!-- 中间页面信息 -->
    <div class="relative w-[800px] h-full min-h-screen mx-auto">
      <!-- 历史对话列表 -->
      <div
      ...
      >
        <div class="mb-9 text-center">
          <div
            class="text-[40px] font-bold mt-[52px] mb-4 text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500"
          >
            Hi，我是智序空间 AI 应用构建器
          </div>
          <div class="text-[30px] font-bold text-gray-800 mb-2">
            你的专属
          ...
          <div class="text-base text-gray-500">
            说出你的创意，我可以快速帮你创建专属应用，一键轻松分享给朋友，也可以一键发布到智序空间平台、微信等多个渠道。
          </div>
        </div>
        <!-- 开场AI对话消息 -->
        <div class="flex gap-2">
          ...
          <a-avatar
            :size="30"
            shape="circle"
            class="flex-shrink-0 bg-gradient-to-br from-cyan-500 to-blue-600"
          >
            <icon-apps />
          </a-avatar>
          <!-- 右侧名称与消息 -->
          <div class="flex flex-col items-start gap-2">
            <!-- 应用名称 -->
            <div class="text-gray-800 font-bold">辅助Agent</div>
            <!-- AI消息 -->
            <div
              class="bg-white/90 backdrop-blur-md border border-white/70 text-gray-700 px-5 py-4 rounded-2xl break-all leading-7 shadow-lg shadow-cyan-100/70"
            >
              <div
                class="font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600"
              >
                你好，欢迎来到智序空间🎉
              </div>
              <div class="text-gray-600">
                智序空间是新一代大模型 AI 应用开发平台。无论你是否有编程基础，都可以快速搭建出各种
              ...
              <div class="text-gray-400">如果你还有其他智序空间使用问题，也欢迎随时问我！</div>
            </div>
            <!-- 开场白建议问题 -->
            <div class="flex flex-col gap-2">
              <div
                ...
                :key="idx"
                class="px-4 py-1.5 border rounded-lg text-gray-700 cursor-pointer bg-white hover:border-blue-300 hover:bg-blue-50 hover:text-blue-600 shadow-sm transition-all duration-200"
      ...
      <div class="w-full flex flex-col flex-shrink-0">
        ...
        <div class="px-6 flex items-center gap-4">
          ...
          <!-- 输入框组件 -->
          <div
            :class="`bg-white ${image_urls.length > 0 ? 'h-[100px]' : 'h-[50px]'} flex flex-col justify-center gap-2 px-4 flex-1 border border-gray-200 rounded-[24px] shadow-sm shadow-blue-100`"
          >
            <!-- 图片列表 -->
            <div
            ...
            <div class="flex items-center gap-2">
              <input
                v-model="query"
                type="text"
                class="flex-1 h-8 bg-transparent outline-none text-gray-700 placeholder:text-gray-400"
                placeholder="向智序空间发送消息或创建AI应用..."
